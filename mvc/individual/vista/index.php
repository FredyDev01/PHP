...
<h1 class="titleSmall mb-14">Administración de animes <hr></h1>
<main class="max-w-max mx-auto bg-white rounded-lg shadow-md">
    <form class="px-6 py-5 mb-5 grid grid-cols-[max-content_max-content_1fr] items-center">        
        <div class="formItem iconRight">
            <input type="text" placeholder="Buscar anime">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            </svg>
        </div>
        <div class="formItem iconRight ml-5">
            <select>
                ...
                if(!empty($dato)):
                    foreach($dato as $key => $value)
                        ...
                        <tr>
                            ...
                            <td class="max-w-[64px]">
                                <img src="<?= $v['imagen_url'] ?>" alt="portada_<?= $v['nombre'] ?>">
                            </td>
                            <td>
